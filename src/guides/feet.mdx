...
# Shielding Bench Feet

The feet of your bench are the most vulnerable to damage, through rot and decay or scraping.
...
<PartsTable items={[
    { qty: 4, name: "2x4 fence bracket (optional, for shielding feet)", img: fenceBracket, width: 0.75 * 400, alt: "Three-sided silver bracket with holes." },
    { qty: 8, name: "1-1/2 in. connector nail (optional, for shielding feet)", img: nail, width: 0.75 * 154, alt: "Short nail with a matte galvanized surface." },
]} />

Connector screws may also be used instead of nails, thought not on the bottom of the feet as they would protrude:
