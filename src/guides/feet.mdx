...
<PartsTable items={[
    { qty: 4, name: "2x4 fence bracket", img: fenceBracket, width: 0.75 * 400, alt: "Three-sided silver bracket with holes." },
    { qty: 8, name: "1-1/2 in. connector nail", img: nail, width: 0.75 * 154, alt: "Short nail with a matte galvanized surface." },
]} />
