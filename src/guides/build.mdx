...
In particular, the front of the `A` piece, and top/back of the `B` piece, and the top/back of the `L` piece are all places people may touch.
...
Each leg frame is assembled from the pieces you cut earlier, connected using the 3/8 in. carriage bolts, nuts, and washers.
