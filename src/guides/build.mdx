...
import legFrameAssemblyLeft from '../../public/img/leg_frame_assembly_left.png';
...
The "slats" are the 6 pieces that span the width of the bench.
Because they will be sat on, the slats especially should be smooth and free of splinters.

Begin by sanding the slats with your sander, using an \~80 grit sanding disc.
Ensure the top side and adjacent edges are smooth and free of splinters.
Give the edges a small round-over for comfort and to prevent splintering.
Holes may be filled with (waterproof) wood filler, but this is optional as long as the hole is not large enough to pose a hazard to small fingers or clothing.
...
We will need to drill pilot holes for the screws that will hold the slats to the legs.
The template has small pairs of holes which are 6, 12, and 18 in. from the end.
The hole distance is determined by the width of the bench, as shown in the table to the right.
Use the small (3/32 to 1/8 in.) drill bit to drill two pairs of pilot holes in each end of the slats (four holes total per slat).
...
| --- |
| Rests and spacers cut from a single 2x4x8. |
</div>
...
Make sure there is adequate time for the stain to dry, usually 12-24 hours depending on temperature, and avoid finishing when rain is expected.

### Prime & Paint

Painting can be done before or after assembly, although some areas are hard to reach on an assembled bench.

Chris Duderstadt, the original designer of the bench, paints his benches after assembly using a spray gun.
He recommends two coats of good primer followed by one or two coats of exterior paint.
He has found Kelly-Moore exterior semi-gloss paint to hold up best.
...
<Steps steps={[
  {
    text: "Tap the long (5 in.) carriage bolt fully through the lowest hole in the `L` long leg.",
    img: legFrameAssemblyLeft1,
    width: 200,
    alt: "A long leg piece with a bolt visibly sticking thru the lowest of three holes.",
  },
  {
    text: "Continue tapping the long bolt through the `C` spacer piece, supporting it on both sides to prevent splitting, then through the middle hole of the `S` short leg.",
  ...
  {
    text: "Tap a short (3-1/2 in.) carriage bolt through the middle hole of the `A` seat rest, then through the top hole of the `S` short leg. Tap a second short bolt _partially_ through the middle hole of the `L` long leg.",
  ...
  {
    text: "Tap a short bolt through the bottom hole of the `B` backrest, then through the bottom hole of the `S` short leg. Tap a second short bolt _partially_ through the top hole of the `L` long leg.",
