...
You can choose to finish either before or after assembly.
...
We may apply the finish now, or after the bench is assembled, see the [finishing guide](finishing).
...
We may apply the finish now, or after the bench is assembled, and we should also seal the end cuts of the leg pieces--
see the [finishing guide](finishing).
...
<div class="caption right">
| <Image src={diagonalBraces} alt="A bench front-view with highlighted braces below the slats connecting to the sides of the leg frames." width={260} densities={[1, 1.25, 1.5, 2]} /> |
| --- |
