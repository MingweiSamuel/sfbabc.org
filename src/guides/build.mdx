...
This sections describes how to assemble a bench with one person and two bar clamps, but if you have friends to help you don't need the clamps.
...
<Steps link={true} steps={[
  {
    text: "On a flat floor, stand up the leg frames in their appoximate final positions. You can use the clamps horizontally to stabilize the feet.",
    img: assembly0,
    width: 320,
  ...
  {
    text: "Place a second seat slat next to the first, with spacers between them. Use your weight to keep the slat from lifting while driving one screw in on each side.",
    img: assembly3,
    width: 390,
