...
Make sure to look up how to use the tools safely.
Clamp the wood to a stable surface while cutting.
The seat dent of the `A` piece is particularly tricky to cut with just a circular saw,
so we may want to start one side of the cut with the circular saw and finish the other side with the jigsaw.
