...
Although they're intended for wood-to-wood connections, here they can act as drillable stakes.
<PartsTable items={[
...
Drive the screws using the impact driver w/ 1/4" socket.
...
For screw anchors, use your impact driver w/ 9/16" socket to drive each anchor through the bracket and into the hole.
