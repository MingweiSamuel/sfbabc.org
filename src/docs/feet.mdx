...
description: Shield bench feet with metal brackets.
order: 19
---
...
The feet of a bench are the most vulnerable to damage, thru rot and decay or scraping.
Metal shielding on the feet can help delay these issues.
...
Rotate the bench upside down, then simply nail the brackets to each of the four feet.
