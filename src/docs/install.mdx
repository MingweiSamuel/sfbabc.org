...
description: How we anchor a bench to the ground.
order: 17
toc: true
---
...
If a bench is placed in public, it should be anchored to the ground to ensure it is stable and
to prevent it from walking away. This documentation shows how we add
mounting brackets to bench feet and anchor them to concrete (or soil).
...
If using a wedge or sleeve anchor, a hammer will also be needed.
...
If needed to [shield the feet of the bench](/docs/feet), do so before attaching the brackets.
...
First, position the bench where it will be installed.
...
For screw anchors, use an impact driver with 9/16" socket to drive each anchor thru the bracket and into the hole.
...
Then simply use an impact driver to drive each lag screw thru the bracket and into the ground.
