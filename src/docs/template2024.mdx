---
title: Template Guide (2024)
description: Navigating the template (November 2024).
order: 1012
---
...
Trace two `A` seat rests, two `B` backrests, and two `C` center spacers from the template onto the other 2x4x8.
...
If you plan to [anchor your bench to the ground](/docs/install), also mark the two slits near the foot for aligning the mounting brackets.

### Positioning

Trace two short `S` legs and two long `L` legs from the template onto the pressure-treated 2x4x8.
