...
|---|:--|:--|
| 2 | 3/8 in. x 5 in. carriage bolt | <Image src={cbLong} alt="Carriage bolt with cloudy galvanized finish." width={0.75 * 512} densities={[1, 1.25, 1.5, 2]} /> |
| 8 | 3/8 in. x 3-1/2 in. carriage bolt | <Image src={cbShort} alt="Carriage bolt with cloudy galvanized finish." width={0.75 * 364} densities={[1, 1.25, 1.5, 2]} /> |
| 10 | 3/8 in. hex nut | <Image src={nut} alt="Hexagonal nut." width={0.75 * 56} densities={[1, 1.25, 1.5, 2]} /> |
| 10 | 3/8 in. flat washer | <Image src={washer} alt="Round flat washer." width={0.75 * 100} densities={[1, 1.25, 1.5, 2]} /> |
| 40 | #8 x 2-1/2 in. exterior screw | <Image src={screw} alt="Shiny bronze-colored screw." width={0.75 * 248} densities={[1, 1.25, 1.5, 2]} /> |
| 4 | [L-bracket with 3/8 in. hole on short side](https://www.amazon.com/dp/B0CGXTD78R/) | <Image src={bracket} alt="L-shaped bracket with small screw holes and larger bolt holes." width={0.75 * 300} densities={[1, 1.25, 1.5, 2]} /> |
| 8 | #9 x 1-1/2 in. connector screw | <Image src={sdScrew} alt="A short silver screw with a protruding hex head." width={0.75 * 168} densities={[1, 1.25, 1.5, 2]} /> |
| 4 | [3/8 in. x 1-3/4 in. or longer concrete anchor](https://www.amazon.com/dp/B09RCV4L5K/) | <Image src={anchor} alt="Stubby shiny silver anchor bolt with deep threads." width={0.75 * 216} densities={[1, 1.25, 1.5, 2]} /> |
