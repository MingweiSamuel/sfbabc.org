...
One gallon of stain or paint will coat 5-6 benches (7 ft. wide) with one layer.
...
|:--|:--|:--|
| _2_ | 3/8 in. x 5 in. carriage bolt | <Image src={cbLong} alt="Carriage bolt with a matte galvanized surface." width={0.75 * 512} densities={[1, 1.25, 1.5, 2]} /> |
| _8_ | 3/8 in. x 3-1/2 in. carriage bolt | <Image src={cbShort} alt="Carriage bolt with a matte galvanized surface." width={0.75 * 364} densities={[1, 1.25, 1.5, 2]} /> |
| _10_ | 3/8 in. hex nut | <Image src={nut} alt="Hexagonal nut." width={0.75 * 56} densities={[1, 1.25, 1.5, 2]} /> |
| _10_ | 3/8 in. flat washer | <Image src={washer} alt="Round flat washer." width={0.75 * 100} densities={[1, 1.25, 1.5, 2]} /> |
| _40_ | #8 x 2-1/2 in. exterior screw | <Image src={screw} alt="Shiny bronze-colored screw." width={0.75 * 248} densities={[1, 1.25, 1.5, 2]} /> |
| _4_ | [L-bracket with hole for 3/8 in. bolt](https://www.amazon.com/dp/B0CGXTD78R/) | <Image src={bracket} alt="L-shaped bracket with small screw holes and larger bolt holes." width={0.75 * 300} densities={[1, 1.25, 1.5, 2]} /> |
| _8_ | #9 x 1-1/2 in. connector screw | <Image src={sdScrew} alt="A short silver screw with a protruding hex head." width={0.75 * 168} densities={[1, 1.25, 1.5, 2]} /> |
| _4_ | 3/8 in. x 1-3/4 in. or longer concrete anchor | <Image src={anchor} alt="Stubby shiny silver anchor bolt with deep threads." width={0.75 * 216} densities={[1, 1.25, 1.5, 2]} /> |
| _4_ | 2x4 fence bracket (optional, for feet) | <Image src={fenceBracket} alt="Three-sided silver bracket with holes." width={0.75 * 400} densities={[1, 1.25, 1.5, 2]} /> |
| _8_ | 1-1/2 in. nail (optional, for feet) | <Image src={nail} alt="Short nail with a matte galvanized surface." width={0.75 * 154} densities={[1, 1.25, 1.5, 2]} /> |
</div>
...
| <Image src={kdHtDfir} alt="Close up of a 2x4 with stamp KD HT and D FIR, among other markings." width={300} densities={[1, 1.25, 1.5, 2]} /> |
| --- |
